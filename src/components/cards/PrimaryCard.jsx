...
const PrimaryCard = (props) => {
  const {
    ...
    cardType = "events",
    rating,
    // New props specific for Test card
    attempted = null,
    mentor = null,
  } = props;
  ...
  // Special rendering for "Test" card type
  if (cardType === "Test") {
    return (
      <div
        className={cardClass}
      ...
      >
        <div className={cardsClass}>
          <a className={styles.cardsminiheading}>{miniHeading /* level */}</a>
          <a className={styles.cardsmainheading} title={mainHeading}>
            {transformMainHeading(mainHeading) /* skill */}
          </a>
          <div className={styles.testInfoRow}>
            <div>
              <strong>Attempted: </strong> {attempted ?? "N/A"}
            </div>
            <div>
              <strong>Mentor: </strong> {mentor ?? "N/A"}
            </div>
          </div>
        </div>
    ...
    >
      <div className={cardsClass} onClick={handleClick}>
        ...
        <div className={styles.dateRow}>
          ...
          <div>{cardType !== "Course" && <GoArrowRight />}</div>
